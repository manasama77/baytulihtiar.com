...
class BeritaController extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('M_backend_berita', 'mberita');
	...
	public function index()
	{
		...
		$data['vitamin']               = 'admin_berita_vitamin';
	...
	public function create()
	{
		...
		$data['vitamin'] = 'admin_berita_form_vitamin';
	...
	public function edit($id)
	{
		...
		$data['vitamin'] = 'admin_berita_form_edit_vitamin';
...
/* Location: ./application/controllers/backend/BeritaController.php */