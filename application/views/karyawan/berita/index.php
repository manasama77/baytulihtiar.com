<div class="page-content">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			<li>
				<a href="<?=site_url('karyawan/berita/index');?>">Berita</a>
		...
		<div class="page-toolbar">
			<div class="btn-group pull-right">
				<a href="<?=site_url('karyawan/berita/create');?>" class="btn green btn-sm btn-outline"><i class="fa fa-plus fa-fw"></i> Tambah Berita </a>
			</div>
		</div>
	</div>
	<!-- END PAGE BAR -->
		...
		<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
			<div class="portlet light  bordered ">
				...
				<div class="portlet-body form">
					<form class="form-horizontal" id="form-filter" method="get" action="<?=site_url('karyawan/berita/index');?>">
						<div class="form-body">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="">Pencarian</label>
								<div class="col-sm-4">
						...
						<div class="form-action">
							<div class="row">
								<div class="col-sm-offset-2 col-sm-10">
									<button type="submit" class="btn green" id="filter" name="filter">Tampilkan</button>
									<a href="<?=site_url('karyawan/berita/index');?>" class="btn default">Reset</a>
								</div>
							</div>
						</div>
					</form>
										...
										<tr>
											<td class="text-center">
												<div class="btn-group btn-group-solid">
													...
													?>
													<a href="<?=site_url();?>karyawan/berita/edit/<?=$arr->id;?>" class="btn blue btn-sm" title="Edit">
