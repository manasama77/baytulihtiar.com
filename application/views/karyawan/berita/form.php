	...
	<div class="page-bar">
		...
		<div class="page-toolbar">
			<div class="btn-group pull-right">
				<a href="<?= site_url('karyawan/berita/index'); ?>" class="btn green btn-sm btn-outline"><i class="fa fa-backward fa-fw"></i> List Berita </a>
			</div>
		</div>
	</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="portlet box blue-hoki">
				...
				<div class="portlet-body">
					<form id="form" method="POST" action="<?= base_url(); ?>karyawan/berita/store" enctype="multipart/form-data">
