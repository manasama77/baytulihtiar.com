<form id="formlogin">
	<div class="form-title">
		<span class="form-title">Login Karyawan</span>
		<span class="form-subtitle">KSPPS Baytul Ikhtiar</span>
	</div>
	<div class="alert alert-danger display-hide">
		<button class="close" data-close="alert"></button>
		<span> Masukan NIK & Password </span>
	</div>
	<?php
	...
	<div class="form-group">
		<label class="control-label visible-ie8 visible-ie9" for="nik">NIK</label>
		<input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Nomor Induk Karyawan" id="nik" name="nik" autofocus />
	</div>
