					...
					<div class="col s12 m4 l4 center">
						...
						<div class="card berita hoverable scale-transition scale-out blue-grey lighten-2" >
							<div class="card-image waves-effect waves-block waves-light">
								<img class="activator responsive-img" src="<?=base_url();?>assets/img/berita/<?=$berita->gambar;?>" style="max-width:400px !important; max-height: 225px !important;">
								<a href="<?=site_url('berita/show/'.$berita->id);?>" class="white-text">
									<span class="card-title waves-effect waves-light" style="background-color: rgb(96,125,139,0.8); font-size:16px; padding:8px; width:100%;"><?=$berita->judul;?> lorem ipsum
									</span>
								</a>
							</div>
