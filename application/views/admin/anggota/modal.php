...
<form method="post" action="<?=base_url();?>backend/anggota/update">
	<div class="form-group">
		<label for="">No Anggota</label>
		<input type="text" class="form-control" id="cif_no_edit" name="cif_no_edit" readonly="true" value="<?=$arrs->row()->cif_no;?>" required>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" id="majlis_edit" name="majlis_edit" value="<?=$arrs->row()->majlis;?>" required>
	</div>
	<div class="form-group">
