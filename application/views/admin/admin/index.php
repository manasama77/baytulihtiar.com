<div class="page-content">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			<li>
				<a href="<?=site_url('backend/admin/index');?>">Admin</a>
				<i class="fa fa-circle"></i>
				<a href="javascript:;">Manage Admin</a>
			</li>
		</ul>
	</div>
	<!-- END PAGE BAR -->
	<!-- BEGIN PAGE TITLE-->
	<h1 class="page-title"> Admin <i class="fa fa-fw fa-angle-right"></i>
		...
		<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
			<div class="portlet box blue-hoki ">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-users"></i>Data Admin
					</div>
				</div>
											...
											?>
												<div class="btn-group btn-group-solid">
													...
													if($arr->flag_aktif == 'tidak aktif'){
														?>
														<button onclick="confirmAktivasi('<?=$arr->id;?>', '1')" class="btn green btn-sm" title="Aktifkan Admin">
													...
													if($arr->flag_aktif == 'aktif'){
														?>
														<button onclick="confirmAktivasi('<?=$arr->id;?>', '0')" class="btn dark btn-sm" title="Non Aktifkan Admin">
			...
			<div class="portlet box blue-hoki ">
				...
				<div class="portlet-body">
					<form id="form">
						...
						<div class="form-group">
							<button type="submit" id="submit" class="btn btn-primary btn-block">Tambah Admin</button>
						</div>
					</form>
				</div>
			</div>
