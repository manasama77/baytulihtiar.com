<div class="page-content">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			<li>
				<a href="<?=site_url('backend/kisah/index');?>">Kisah</a>
		...
		<div class="page-toolbar">
			<div class="btn-group pull-right">
				<a href="<?=site_url('backend/kisah/create');?>" class="btn green btn-sm btn-outline"><i class="fa fa-plus fa-fw"></i> Tambah Kisah </a>
			</div>
		</div>
	</div>
	<!-- END PAGE BAR -->
		...
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
			<div class="portlet light  bordered ">
				...
				<div class="portlet-body form">
					<form class="form-horizontal" id="form-filter" method="get" action="<?=site_url('backend/kisah/index');?>">
						<div class="form-body">
						...
						<div class="form-action">
							<div class="row">
								<div class="col-sm-offset-3 col-sm-9">
									...
									<a href="<?=site_url('backend/kisah/index');?>" class="btn default">Reset</a>
								</div>
							</div>
						</div>
					</form>
										...
										<tr>
											<td class="text-center">
												<div class="btn-group btn-group-solid">
													<a href="<?=site_url();?>backend/kisah/edit/<?=$arr->id;?>" class="btn blue btn-sm" title="Edit">
													...
													?>
													<button onclick="confirmAktivasi('<?=$arr->id;?>', '1')" class="btn green btn-sm" title="Aktifkan Kisah">
													...
													?>
													<button onclick="confirmAktivasi('<?=$arr->id;?>', '0')" class="btn dark btn-sm" title="Non Aktifkan Kisah">
